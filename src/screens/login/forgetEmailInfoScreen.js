...
const ForgetResetPasswordScreen = ({ navigation }) => {
                    ...
                    <Button
                        handlePress={async () => {
                            if (email !== "") {
                                ...
                                navigation.navigate("Validation", { username: email });
                            } else {
                                setMessageShown("Please enter your email.");
...
export default ForgetResetPasswordScreen;
